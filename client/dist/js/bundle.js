...
var _registerComponents = _interopRequireDefault(__webpack_require__(/*! ./registerComponents */ "./client/src/js/boot/registerComponents.js"));
...
/***/ "./client/src/js/boot/registerComponents.js":
/*!**************************************************!*\
  !*** ./client/src/js/boot/registerComponents.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var _EmbargoExpiryField = _interopRequireDefault(__webpack_require__(/*! ../components/EmbargoExpiryField */ "./client/src/js/components/EmbargoExpiryField.jsx"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
var _default = function _default() {
  _Injector["default"].component.registerMany({
    EmbargoExpiryField: _EmbargoExpiryField["default"]
  });
};
...
/***/ "./client/src/js/components/EmbargoExpiryField.jsx":
/*!*********************************************************!*\
  !*** ./client/src/js/components/EmbargoExpiryField.jsx ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var _submitEmbargoExpiryForm = _interopRequireDefault(__webpack_require__(/*! ../mutations/submitEmbargoExpiryForm */ "./client/src/js/mutations/submitEmbargoExpiryForm.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
...
var EmbargoExpiryField = function EmbargoExpiryField(props) {
  var _useMutation = (0, _client.useMutation)(_submitEmbargoExpiryForm["default"]),
  ...
  var desiredPublishDateRef = (0, _react.useRef)(null);
  var desiredUnPublishDateRef = (0, _react.useRef)(null);
  if (loading) return null;
  if (error) return null;
  var submittedFormData = data ? data.submitEmbargoExpiryForm : null;
  ...
  return _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement("div", {
    className: "form-group field text datetime"
  }, _react["default"].createElement("label", {
    className: "form__field-label"
  }, "Desired Publish Date"), _react["default"].createElement("div", {
    className: "form__fieldgroup form__field-holder text datetime"
    ...
    className: "form__field-label"
  }, "Current Publish Date"), _react["default"].createElement("div", {
    className: "form__fieldgroup form__field-holder text"
  }, _react["default"].createElement("input", {
    name: "publishDate",
    type: "text",
    className: "text",
    ...
    className: "form__field-label"
  }, "Desired Un-Publish Date"), _react["default"].createElement("div", {
    className: "form__fieldgroup form__field-holder text datetime"
  }, _react["default"].createElement("input", {
    ...
    className: "form__field-label"
  }, "Current Un-Publish Date"), _react["default"].createElement("div", {
    className: "form__fieldgroup form__field-holder text"
  }, _react["default"].createElement("input", {
    name: "unPublishDate",
    type: "text",
...
var _default = EmbargoExpiryField;
exports["default"] = _default;

/***/ }),

/***/ "./client/src/js/legacy/entwine/EmbargoExpiryField.entwine.js":
/*!********************************************************************!*\
  !*** ./client/src/js/legacy/entwine/EmbargoExpiryField.entwine.js ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
...
_jquery["default"].entwine('ss', function ($) {
  $('.js-injector-boot .EmbargoExpiryField').entwine({
    onmatch: function onmatch() {
      var Component = (0, _Injector.loadComponent)('EmbargoExpiryField');
      var schemaState = this.data('state');
      var setValue = function setValue(fieldName, value) {
        var input = document.querySelector("input[name=\"".concat(fieldName, "\"]"));
        if (!input) {
          return;
        }
        input.value = value;
...
/***/ "./client/src/js/mutations/submitEmbargoExpiryForm.js":
/*!************************************************************!*\
  !*** ./client/src/js/mutations/submitEmbargoExpiryForm.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
__webpack_require__(/*! ./legacy/entwine/EmbargoExpiryField.entwine.js */ "./client/src/js/legacy/entwine/EmbargoExpiryField.entwine.js");
__webpack_require__(/*! ./boot */ "./client/src/js/boot/index.js");
})();
